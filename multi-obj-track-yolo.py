...
if __name__ == '__main__':
    ...
    ap.add_argument("-g", "--config", required=True, help="path to Yolo config file")
    ap.add_argument("-m", "--model", required=True, help="path to Yolo model")
    ap.add_argument("-v", "--video", required=True, help="path to input video file")
    ap.add_argument("-l", "--label", required=True, help="class label we are interested in detecting + tracking")
    ap.add_argument("-s", "--classes", required=True, help="Text file with a list of classes detected by model")
